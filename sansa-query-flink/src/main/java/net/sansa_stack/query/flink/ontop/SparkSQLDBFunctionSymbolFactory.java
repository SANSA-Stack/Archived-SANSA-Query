...
public class SparkSQLDBFunctionSymbolFactory extends AbstractSQLDBFunctionSymbolFactory {
    ...
    protected DBConcatFunctionSymbol createNullRejectingDBConcat(int arity) {
        return new net.sansa_stack.query.flink.ontop.NullRejectingDBConcatFunctionSymbol(CONCAT_OP_STR, arity, dbStringType, abstractRootDBType, true);
    }
    ...
    protected DBConcatFunctionSymbol createRegularDBConcat(int arity) {
        return new net.sansa_stack.query.flink.ontop.NullToleratingDBConcatFunctionSymbol(CONCAT_STR, arity, dbStringType, abstractRootDBType, false);
    }

    @Override
    protected DBFunctionSymbol createCeilFunctionSymbol(DBTermType dbTermType) {
        return new net.sansa_stack.query.flink.ontop.UnaryDBFunctionSymbolWithSerializerImpl(CEIL_STR, dbTermType, dbTermType, false,
    ...
    protected DBFunctionSymbol createFloorFunctionSymbol(DBTermType dbTermType) {
        return new net.sansa_stack.query.flink.ontop.UnaryDBFunctionSymbolWithSerializerImpl(FLOOR_STR, dbTermType, dbTermType, false,
                (terms, termConverter, termFactory) -> String.format(
    ...
    protected DBFunctionSymbol createRoundFunctionSymbol(DBTermType dbTermType) {
        return new net.sansa_stack.query.flink.ontop.UnaryDBFunctionSymbolWithSerializerImpl(ROUND_STR, dbTermType, dbTermType, false,
                (terms, termConverter, termFactory) -> String.format(
    ...
    protected DBFunctionSymbol createDBAvg(DBTermType inputType, boolean isDistinct) {
        ...
        if (inputType.equals(dbIntegerType))
            return new net.sansa_stack.query.flink.ontop.ForcingFloatingDBAvgFunctionSymbolImpl(inputType, dbDecimalType, isDistinct);
    ...
    public DBBooleanFunctionSymbol getDBRegexpMatches2() {
        return new net.sansa_stack.query.flink.ontop.DBBooleanFunctionSymbolWithSerializerImpl(REGEXP_LIKE_STR + "2",
